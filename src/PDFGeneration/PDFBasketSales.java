...
import static DbController.SalesTranscationController.getSalesTranscation;
...
public class PDFBasketSales {
    ...
    public PDFBasketSales(String yearsession, String stdsession, String studentName, String SaleId, String total) {
...
//        createPdf("Report/"+Vquotationno + "-" + timestamp + ".pdf");
    ...
    private String getpath(String yearsession, String stdsession) {
        ...
        return desktopPath.replace("\\", "/") + "/Dpark/" + yearsession + "/" + stdsession + "/BasketSales/" + datenew + bpath1 + ".pdf";
    }
    ...
    private void createPdf(String Destination, String yearsession, String stdsession, String studentName, String SaleId, String total) {
        try {
            ...
            ResultSet data = getSalesTranscation(yearsession, stdsession, SaleId);
            int j = 1;
            while (data.next()) {
                t4.getDefaultCell().setHorizontalAlignment(Element.ALIGN_CENTER);
            ...
            Logger.getLogger(PDFBasketSales.class.getName()).log(Level.SEVERE, null, ex);
